...
// Named Basic Color
val LIGHTER_BLUE = Color(0xFFBEF1F9)
val LIGHT_BLUE = Color(0xFF5E8EB6)
val BLACK = Color(0xFF000000)
val MEDIUM_BLUE = Color(0xFF4167A6)

val DARK_PURPLE = Color(0xFF4d306a)
val WHITE = Color(0xFFFFFFFF)
val DARKER_PURPLE = Color(0xFF321F46)

val DARK_BLUE = Color(0xFF2A3673)
val DARKER_BLUE = Color(0xFF060731)

val LIGHTER_PURPLE = Color(0xFFC3A6C4)
val LIGHT_PURPLE = Color(0xFFA698B4)
val MEDIUM_PURPLE = Color(0xFF4A4F9F)

// Gradient Colors
val GRA_HOR_BLACK_PURPLE = Brush.horizontalGradient(listOf(DARKER_BLUE, DARK_BLUE))
val GRA_HOR_BLUE_PURPLE = Brush.horizontalGradient(listOf(LIGHTER_BLUE, LIGHT_BLUE))

val GRA_VER_PURPLE_BLACK = Brush.verticalGradient(listOf(MEDIUM_PURPLE, BLACK))
val GRA_VER_PURPLE_WHITE = Brush.verticalGradient(listOf(MEDIUM_PURPLE, WHITE))
val GRA_VER_BLUE_PURPLE = Brush.verticalGradient(listOf(DARK_BLUE, MEDIUM_PURPLE))
